    ...
    def MonthlySales_Report(self):
        ...
        if not os.path.isfile(File2):
            ...
            if (monthNo <= 12 and monthNo <= self.mm and yearNo <= self.yy):
                ...
                print ("{0:<20} {1:<12} {2:<25} {3:^10} {4:>5} {5:>12} {6:>8}". format("Name", "Mobile No.", "Cassette/CD Cide and Name", "Date", "Qty", "Unit price", "Amount"))
                    ...
                    while True:
                        ...
                        if (monthNo == CustRec[6] and yearNo == CustRec[7]):
                            ...
                            for i in range(len(Clength)):   #Extracts only 24 characters
                                ...
                                print ("{0:20} {1:<12} {2:<25} {3:>10} {4:>5.0f} {5:>12.2f} {6:>8.2f}". format(CustRec[1], CustRec[3], nName, nDt, CustRec[4], UPrice, Amount))
    ...
    def CodeWiseMonthlySales_Report(self):
        ...
        if not os.path.isfile(File2):
            ...
            if (monthNo <= 12 and  monthNo <= self.mm and yearNo <= self.yy and Flag == True):
                ...
                print ("{0:<20} {1:<12} {2:^10} {3:>5} {4:>12} {5:>8}". format("Name", "Mobile No.", "Cassette/CD Cide and Name", "Date", "Qty", "Unit price", "Amount"))
                ...
                try:
                    ...
                    while True:
                        ...
                        if (monthNo == CustRec[6] and yearNo == CustRec[7]) and (CCode == CustRec[0]):
                            ...
                            print ("{0:20} {1:<12} {2:>10} {3:>5.0f} {4:>12.2f} {5:>8.2f}". format(CustRec[1], CustRec[3], nDt, CustRec[4], UPrice, Amount))
